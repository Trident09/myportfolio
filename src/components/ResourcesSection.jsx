...
function ResourcesSection() {
	return (
		<section
			id="services"
			className="py-16 px-10 md:px-20 w-full min-h-[90vh] bg-tertiarybg text-bg flex flex-col justify-center items-center"
		>
			<div className="py-4 px-0 section-services">
				<div className="my-0 py-0">
					...
					<p className="text-secondarybg text-xl leading-relaxed w-[85%] tracking-wide">
				...
				<div className="service-con mt-8 mb-0 mx-auto grid gap-10">
					{Services.map((service) => (
						<div class="service-box text-center rounded-md py-6 px-[1.4rem]">
							...
							<div className="flex flex-col items-center justify-center">
								<p className="text-secondarybg text-base leading-relaxed">
									{service.text}
								</p>
							</div>
						</div>
